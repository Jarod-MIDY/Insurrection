...
enum GameRoles: string
{
    ...
    public function getDescription(): string
    {
        return match ($this) {
            self::POWER
                => 'Jouer le Pouvoir, c’est être en haut de la pyramide et pourtant dans une situation constamment chancelante, ne reposant que sur des alliances stratégiques parfois précaires.',
            self::ORDER
                => 'Jouer l’Ordre, c’est être soumis au Pouvoir alors qu’on a les armes, essayer de protéger un Peuple qui vous méprise, essayer de faire tenir la charpente dans un monde qui brûle.',
            self::ECHO
                => 'Jouer l’Écho, c’est louvoyer entre déontologie, communication, investigation, proximité avec le Pouvoir et idéal de vérité. Et raconter tout ça devant vos yeux ébahis.',
            self::PEOPLE
                => 'Jouer le Peuple, c’est avoir la force du nombre et la faiblesse de l’inertie. Râler, quémander, commenter, manifester parfois. Personne ne fera rien sans vous, mais va d’abord falloir vous mobiliser.',
            self::MOLOTOV
                => 'Jouer le Molotov, c’est s’habiller en noir, aller dans la rue et se frotter aux forces de l’ordre.',
            self::BADGE => 'Jouer l’Écusson, c’est faire partie du système et s’en détacher progressivement.',
            self::PAMPHLET
                => 'Jouer le Pamphlet, c’est penser la révolution et imaginer l’après en essayant de ne pas faire l’économie des questions difficiles.',
            self::STAR
                => 'Jouer l’Étoile, c’est acquérir de l’influence peu à peu, jusqu’à se demander si on se bat pour ses idées ou pour sa propre hubris.',
        };
    }
    ...
    public function getImmersion(): string
    {
        return match ($this) {
            self::POWER
                => "C'est vous qui tirez les ficelles. Qu'elles soient économiques, législatives, religieuses ou féodales n'y change pas grand-chose. L'important, c'est que vous savez ce qui est bon pour les autres. Oui, même si les autres ne sont pas d'accord. Et non ce n'est pas immoral si vous en profitez au passage. Après tout, vous faites le job.",
            self::ORDER
                => "Si tout le monde se comportait de façon citoyenne, il n'y aurait pas de problème. Mais voilà, y'a toujours des petits malins pour se croire tout permis. Alors faut les rappeler à l'ordre ; de façon musclée si nécessaire. Et devant les autres des fois que ça leur donnerait des idées.",
            self::ECHO
            ...
            self::STAR
                => "Tu n'es pas entrée dans l'arène il y a très longtemps, mais tu fais déjà des étincelles. Bien sûr, tu as des idées, des convictions. Bien entendu tu sais quelle cause tu défends. Mais tu la défendras mieux depuis le haut de la pyramide, non ? Et s'il faut faire quelques compromis pour y arriver ? Peut-être que le jeu en vaut la chandelle, après tout ?",
        };
    }
    ...
    /**
     * Summary of getCharacterSheet
     * @param null|\App\Records\InformationCollection $data
     * @throws \TypeError
     * @throws \ValueError
     * @return CharacterSheet
     */
    public function getCharacterSheet(null|InformationCollection $data = null): CharacterSheet
    {
        return match ($this) {
